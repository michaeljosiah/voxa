...
/// <summary>
/// In-memory <see cref="System.Net.WebSockets.WebSocket"/> for tests. Captures every send;
/// lets tests inject scripted receive frames via <see cref="QueueIncomingBinaryAsync"/> and
/// <see cref="QueueIncomingTextAsync"/>.
/// </summary>
internal sealed class FakeWebSocket : System.Net.WebSockets.WebSocket
{
    ...
    public ValueTask QueueIncomingBinaryAsync(byte[] pcm, bool endOfMessage = true)
        => _incoming.Writer.WriteAsync((WebSocketMessageType.Binary, pcm, endOfMessage));
