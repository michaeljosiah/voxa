...
/// the six sections construct, the registry has the local tier, and nothing touches the network
...
public class StudioBootTests
{
    ...
    public void Section_Views_All_Construct()
    {
        ...
        foreach (var section in new[] { 1, 2, 3, 4, 5, 0 })
