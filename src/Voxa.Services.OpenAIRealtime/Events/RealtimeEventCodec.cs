...
namespace Voxa.Services.OpenAIRealtime.Events;

/// <summary>
/// Builds outgoing OpenAI Realtime API event JSON and decodes incoming server events into
/// Voxa <see cref="Frame"/>s. The protocol matches the OpenAI Realtime spec exactly.
/// </summary>
internal static class RealtimeEventCodec
{
    ...
    public static string BuildSessionUpdate(OpenAIRealtimeOptions options)
    {
